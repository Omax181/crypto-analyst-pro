...
> ⚠️ **Mise à jour V9** : le **Panic mode** (alertes intraday flash) a été
> **entièrement retiré**. L'agent n'envoie plus QUE 3 emails : matin, soir et
> bilan hebdo. Les mentions du « Panic mode » ci-dessous sont **historiques** et
> ne s'appliquent plus. Workflows actuels : `Morning`, `Evening`, `Weekly`,
> `Heartbeat`, `Mettre à jour le portfolio`.
