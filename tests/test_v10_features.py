...
def test_deribit_options_metrics_parsing(monkeypatch) -> None:
    ...
    def fake_get_json(url, **k):
        if "book_summary" in url:
            return {"result": [
                {"instrument_name": "BTC-27JUN26-60000-C", "open_interest": 100, "underlying_price": 65000},
                {"instrument_name": "BTC-27JUN26-70000-P", "open_interest": 120, "underlying_price": 65000},
                {"instrument_name": "BTC-27JUN26-65000-C", "open_interest": 50, "underlying_price": 65000},
            ]}
