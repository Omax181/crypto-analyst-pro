        ...
        for tf_name, tf_lib in _TF_MAP.items():
            try:
                ...
                signals[tf_name] = {
                    ...
                    "close": ind.get("close"),
                    # Indicateurs bruts additionnels (analyse détaillée V10) :
                    # momentum, oscillateurs et moyennes mobiles. Permettent à
                    # Gemini de raisonner sur des valeurs réelles (RSI=72,
                    # Stoch=85, prix vs SMA200…) plutôt que sur un label agrégé.
