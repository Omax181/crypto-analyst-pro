...
def get_quotes(symbols: list[str]) -> dict[str, dict[str, Any]]:
    ...
    def _fetch() -> Any:
        return get_json(
            ...
            # skip_invalid : un symbole inconnu de CMC (ex. SATS, NOT) ne doit pas
            # faire échouer tout le batch — CMC renvoie alors les symboles valides
            # et ignore les autres (essentiel pour le cross-check des 28 positions).
